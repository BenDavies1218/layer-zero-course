...
npx hardhat run courses/omnichain-messaging/scripts/deploy-simple-messenger.ts --network ethereum-sepolia

# Deploy to Arbitrum Sepolia
npx hardhat run courses/omnichain-messaging/scripts/deploy-simple-messenger.ts --network arbitrum-sepolia

# Deploy to Optimism Sepolia
npx hardhat run courses/omnichain-messaging/scripts/deploy-simple-messenger.ts --network optimism-sepolia

# Deploy to Base Sepolia
npx hardhat run courses/omnichain-messaging/scripts/deploy-simple-messenger.ts --network base-sepolia

# Deploy to Polygon Amoy
npx hardhat run courses/omnichain-messaging/scripts/deploy-simple-messenger.ts --network polygon-amoy
```
